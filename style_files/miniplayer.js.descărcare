(function(g){var window=this;'use strict';var z5a=function(a){g.X.call(this,{F:"div",L:"ytp-miniplayer-ui"});this.Ue=!1;this.player=a;this.P(a,"minimized",this.Vg);this.P(a,"onStateChange",this.UK)},O6=function(a){g.bO.call(this,a);
this.j=new z5a(this.player);this.j.hide();g.AN(this.player,this.j.element,4);a.vf()&&(this.load(),g.N(a.getRootNode(),"ytp-player-minimized",!0));this.player.R().K("web_rounded_containers")&&g.N(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.u(z5a,g.X);g.k=z5a.prototype;
...
a=new g.N2(this.player,this);g.M(this,a);a.xa(this.Zh.element);this.Or=new g.X({F:"div",L:"ytp-miniplayer-controls"});g.M(this,this.Or);this.Or.xa(this.Zh.element);this.P(this.Or.element,"click",this.zD);var b=new g.X({F:"div",L:"ytp-miniplayer-button-container"});g.M(this,b);b.xa(this.Or.element);a=new g.X({F:"div",L:"ytp-miniplayer-play-button-container"});g.M(this,a);a.xa(this.Or.element);var c=new g.X({F:"div",L:"ytp-miniplayer-button-container"});g.M(this,c);c.xa(this.Or.element);this.KR=new g.sQ(this.player,
this,!1);g.M(this,this.KR);this.KR.xa(b.element);b=new g.qQ(this.player,this);g.M(this,b);b.xa(a.element);this.nextButton=new g.sQ(this.player,this,!0);g.M(this,this.nextButton);this.nextButton.xa(c.element);this.di=new g.FR(this.player,this);g.M(this,this.di);this.di.xa(this.Zh.element);this.wc=new g.DQ(this.player,this);g.M(this,this.wc);g.AN(this.player,this.wc.element,4);this.pD=new g.X({F:"div",L:"ytp-miniplayer-buttons"});g.M(this,this.pD);g.AN(this.player,this.pD.element,4);a=new g.X({F:"button",
Ca:["ytp-miniplayer-close-button","ytp-button"],T:{"aria-label":"Close"},S:[g.eL()]});g.M(this,a);a.xa(this.pD.element);this.P(a.element,"click",this.ek);a=new g.X({F:"button",Ca:["ytp-miniplayer-replay-button","ytp-button"],T:{"aria-label":"Close"},S:[g.kL()]});g.M(this,a);a.xa(this.pD.element);this.P(a.element,"click",this.I1);this.P(this.player,"presentingplayerstatechange",this.bd);this.P(this.player,"appresize",this.xb);this.P(this.player,"fullscreentoggled",this.xb);this.xb()};
...
g.k.I1=function(){this.player.playVideo()};
